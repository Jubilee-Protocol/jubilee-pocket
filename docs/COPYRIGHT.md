...
Jubilee Pocket, including its source code, documentation, branding, and associated materials, is the intellectual property of Jubilee Labs LLC.
...
- Solana Mobile Stack (Apache 2.0)
- Jupiter Aggregator SDK (MIT License)

## Attribution

Built with ❤️ by Jubilee Labs for the Solana ecosystem.
